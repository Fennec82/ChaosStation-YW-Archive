...
/datum/job/scientist
	...
	minimal_access = list(access_robotics, access_tox, access_tox_storage, access_research, access_xenoarch)
...
/datum/job/roboticist
	...
	selection_color = "#633D63"
	economic_modifier = 5
	access = list(access_robotics, access_tox, access_tox_storage, access_tech_storage, access_morgue, access_research,access_medical, access_medical_equip) //As a job that handles so many corpses, it makes sense for them to have morgue access //CS addition-Medical Access.
