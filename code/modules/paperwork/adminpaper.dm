...
/obj/item/weapon/paper/admin/proc/generateHeader()
	...
	var/text = null
	var/logo = tgui_alert(usr, "Do you want the header of your fax to have a NanoTrasen, SolGov, Syndicate, or Trader logo?","Fax Logo",list("NanoTrasen","SolGov", "Syndicate", "Trader")) //VOREStation Add - Trader //Chaosstation add - Syndicate
	if(logo == "SolGov")
		logo = "sglogo.png"
